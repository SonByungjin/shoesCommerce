    ...
    return (
      <div className="SizeFind">
        <div className="sizeFindContainer">
          <div className="top">
            <img src="https://cfdist.thefitapi.com/shoes_b2b_images/service_images/converse_logo_s4.png" />
          ...
          <div className="containerTwo">
            <div className="first">
              <div>
                <img src="https://cfdist.thefitapi.com/shoes_b2b_images/service_images/step0_foot.png" />
                <span>나의 발 사이즈로 알맞는 사이즈 찾아보기</span>
              </div>
            </div>
            <div className="second">
              <div>
                <img src="https://cfdist.thefitapi.com/shoes_b2b_images/service_images/step0_shoes.png" />
